...
var_labels <- c(
    ...
    previous_neck_irradiation = "Previous neck irradiation",
    referral_source = "Referral source",
    neck_symptoms = "Neck Symptoms",
    incidental_imaging = "Incidental Imaging",
    incidental_imaging_type = "Incidental Imaging Type",
    abnormal_thyroid_function = "Abnormal Thyroid Function",
    ...
    palpable_lymphadenopathy = "Palpable Lymphadenopathy",
    nodule_rapid_growth = "Nodule Rapid Growth",
    nodule_ultrasound_description = "Description of nodule(s) on ultrasound",
    nodule_maxmimum_diameter_mm = "Maximum diameter of largest Thyroid nodule (mm)",
    nodule_ultrasound_u_stage = "Reported U stage",
    nodule_ultrasound_lymphadenopathy = "Lymphadenopathy documented",
    nodule_fna = "FNA of thyroid nodule performed",
    nodule_fna_result = "Thy or Bethesda stag reported",
    nodule_fna_thy = "Thy result",
    core_biopsy = "Core biopsy performed",
    initial_management_decision = "Initial management decision",
    routine_review_offered = "Routine review offered (if no intervention)",
    routine_review_offered_interval_weeks = "",
    routine_review_ultrasound = "Ultrasound repeated at routine review",
    routine_review_fna = "FNA repeated at routine review",
    routine_review_management_strategy_review = "",
    routine_review_management_revised = "Management strategy changed at review",
    routine_review_management_revised_reason = "Reason for change in management",
    routine_review_confirm_management_plan = "Confirmation of management plan when last seen",
